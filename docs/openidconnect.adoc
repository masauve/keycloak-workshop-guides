...
<5> Click on attributes and add key avatar_url with value https://www.keycloak.org/resources/images/logo.svg. 
...
[source, json]
----
"avatar_url": "https://www.keycloak.org/resources/images/logo.svg",
