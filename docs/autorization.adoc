...
Login to your SSO instance again; https://leycloak-{{ USER_ID }}-keycloak.{{ ROUTE_SUBDOMAIN }}
...
[source, shell]
----
#quarkus.oidc.auth-server-url=https://leycloak-{{ USER_ID }}-keycloak.{{ ROUTE_SUBDOMAIN }}/auth/realms/quarkus <1> 
...
----
 export access_token=$(\
    curl --insecure -X POST https://leycloak-{{ USER_ID }}-keycloak.{{ ROUTE_SUBDOMAIN }}/auth/realms/quarkus/protocol/openid-connect/token \
